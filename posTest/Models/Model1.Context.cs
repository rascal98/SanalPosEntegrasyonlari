...
namespace posTest.Models
{
    ...
    public partial class OdemeEntities : DbContext
    {
        public OdemeEntities()
            : base("name=OdemeEntities")
        {
        }
        ...
        public virtual DbSet<BankaParametreleri> BankaParametreleri { get; set; }
        public virtual DbSet<FirmaBankaBaglama> FirmaBankaBaglama { get; set; }
        public virtual DbSet<FirmaKullaniciBaglama> FirmaKullaniciBaglama { get; set; }
        public virtual DbSet<Firmalar> Firmalar { get; set; }
        public virtual DbSet<FirmaParametreleri> FirmaParametreleri { get; set; }
        public virtual DbSet<FirmaPosBilgileri> FirmaPosBilgileri { get; set; }
        public virtual DbSet<FirmaTaksitleri> FirmaTaksitleri { get; set; }
        public virtual DbSet<KartBinNumaralari> KartBinNumaralari { get; set; }
        public virtual DbSet<Loglar> Loglar { get; set; }
        public virtual DbSet<OdemeIstekleri> OdemeIstekleri { get; set; }
        ...
        public virtual DbSet<OdemeLog> OdemeLog { get; set; }
        ...
        public virtual ObjectResult<aspnet_Roles_GetAllRoles_Result> aspnet_Roles_GetAllRoles(string applicationName)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<aspnet_Roles_GetAllRoles_Result>("aspnet_Roles_GetAllRoles", applicationNameParameter);
        }
